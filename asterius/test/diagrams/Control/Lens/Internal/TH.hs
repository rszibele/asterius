...
#define CURRENT_PACKAGE_KEY "this"
...
traversalTypeName       = ''Control.Lens.Type.Traversal

traversal'TypeName     :: Name
traversal'TypeName      = ''Control.Lens.Type.Traversal'

lensTypeName           :: Name
lensTypeName            = ''Control.Lens.Type.Lens

lens'TypeName          :: Name
lens'TypeName           = ''Control.Lens.Type.Lens'

isoTypeName            :: Name
isoTypeName             = ''Control.Lens.Type.Iso

iso'TypeName           :: Name
iso'TypeName            = ''Control.Lens.Type.Iso'

getterTypeName         :: Name
getterTypeName          = ''Control.Lens.Type.Getter

foldTypeName           :: Name
foldTypeName            = ''Control.Lens.Type.Fold

prismTypeName          :: Name
prismTypeName           = ''Control.Lens.Type.Prism

prism'TypeName         :: Name
prism'TypeName          = ''Control.Lens.Type.Prism'

reviewTypeName          :: Name
reviewTypeName           = ''Control.Lens.Type.Review

wrappedTypeName         :: Name
wrappedTypeName          = ''Control.Lens.Wrapped.Wrapped

unwrappedTypeName       :: Name
unwrappedTypeName        = ''Control.Lens.Wrapped.Unwrapped

rewrappedTypeName       :: Name
rewrappedTypeName        = ''Control.Lens.Wrapped.Rewrapped

_wrapped'ValName        :: Name
_wrapped'ValName         = 'Control.Lens.Wrapped._Wrapped'

isoValName              :: Name
isoValName               = 'Control.Lens.Iso.iso

prismValName            :: Name
prismValName             = 'Control.Lens.Prism.prism

untoValName             :: Name
untoValName              = 'Control.Lens.Review.unto
